...
const processProductData = (products: Product[]): Product[] => { //допоміжна функція, що містить логіку 
    return products.map(product => {                             //обробки помилок для нормального відображення картинок
